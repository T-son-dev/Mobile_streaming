const PlusMinusIcon = () => (
  ...
  >
    ...
    <path
      fill="currentColor"
      fill-rule="evenodd"
      d="M12 22c-4.714 0-7.07 0-8.535-1.465l17.07-17.07C22 4.928 22 7.284 22 12s0 7.071-1.464 8.535C19.07 22 16.714 22 12 22m6-4.25a.75.75 0 0 0 0-1.5h-5a.75.75 0 0 0 0 1.5z"
      clip-rule="evenodd"
    />
  </svg>
);
